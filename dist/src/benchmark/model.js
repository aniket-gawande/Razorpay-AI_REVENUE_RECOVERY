export function computeRecoveryProbability(profile) {
    ...
    if (profile.failureCode === 'GATEWAY_ERROR')
        z += 1.30;
    if (profile.failureCode === 'INSUFFICIENT_FUNDS')
        z -= 0.55;
    if (profile.failureCode === 'PAYMENT_CANCELLED_BY_USER')
        z += 0.40;
